...
__export(index_exports, {
  ...
  ComponentResourceOperations: () => ComponentResourceOperations,
  ...
  WeftLedgerStateClient: () => WeftLedgerStateClient,
  WeftStakingOperations: () => WeftStakingOperations,
  XUSDC_RESOURCE: () => XUSDC_RESOURCE,
  configAndServiceKeyPlugin: () => configAndServiceKeyPlugin,
  createBaseTransactionParams: () => createBaseTransactionParams,
  decodeCDP: () => decodeCDP,
  defaultLendingPools: () => defaultLendingPools,
  duToResourceMapping: () => duToResourceMapping,
  interestStrategyPlugin: () => interestStrategyPlugin,
  resourceToDuMapping: () => resourceToDuMapping,
  servicePlugin: () => servicePlugin,
  serviceStatusStrategyPlugin: () => serviceStatusStrategyPlugin,
})
module.exports = __toCommonJS(index_exports)

// src/api/base-client.ts
const import_babylon_gateway_api_sdk = require('@radixdlt/babylon-gateway-api-sdk')
...
var WeftLedgerStateClient = class _WeftLedgerStateClient {
  ...
  static setInstance(radixGatewayApi) {
    if (!this.instance) {
      const defaultApi = radixGatewayApi ?? import_babylon_gateway_api_sdk.GatewayApiClient.initialize({
