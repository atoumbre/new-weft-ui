import type { FungibleResourcesCollection, GatewayApiClient, LedgerStateSelector, NonFungibleResourcesCollection, ProgrammaticScryptoSborValue, ProgrammaticScryptoSborValueEnum, StateApi, StateEntityDetailsResponseFungibleResourceDetails, StateEntityDetailsResponseNonFungibleResourceDetails, StateNonFungibleLocationResponseItem, TransactionPreviewRequest } from '@radixdlt/babylon-gateway-api-sdk'
...
declare class ComponentResourceOperations {
  ...
  getResourceInfos(componentAddress: string[], ledgerStateSelector?: LedgerStateSelector): Promise<Record<string, MarketResourceInfo>>
}
...
export { type CacheEntry, CDP_RESOURCE, CdpOperations, type ClaimNFT, type CollateralConfig, type CollateralConfigVersion, type CollateralInfo, type CollateralizeDebtPositionData, type CollateralPositionData, type CollateralResource, type CollateralResourceConfig, type CollateralService, ComponentResourceOperations, configAndServiceKeyPlugin, type ConfigurationEntry, type ConfigurationManager, type ContributionState, createBaseTransactionParams, decodeCDP, defaultLendingPools, type DepositLimitType, duToResourceMapping, type EfficiencyGroup, type EfficiencyMode, type FetchResult, type FungibleResource, type GlobalCollateralService, InterestStrategy, interestStrategyPlugin, type IsBreakPoint, type IsolationGroup, LENDING_MARKET_COLLATERAL_CONFIG_KVS, LENDING_MARKET_COLLATERAL_SERVICE_KVS, LENDING_MARKET_COMPONENT, LENDING_MARKET_EFFICIENT_GROUP_KVS, LENDING_MARKET_LOAN_CONFIG_KVS, LENDING_MARKET_LOAN_SERVICE_KVS, LENDING_MARKET_PRICE_CACHE_KVS, LENDING_MARKET_RES_CONFIG_KVS, LENDING_POOL_COMPONENT, LENDING_POOL_INTEREST_STRATEGY_KVS, LENDING_POOL_RESOURCE_POOL_KVS, LENDING_POOL_SERVICE_KVS, type LendingMarketState, type LendingPoolProtocolFeeConfig, type LendingPoolProxy, type LendingPoolState, type LendingService, type LoanConfig, type LoanInfo, type LoanPositionData, type LoanResource, type LoanResourceConfig, type LoanService, type LSUResource, type MarketConfig, MarketOperations, type MarketProtocolFeeConfig, type MarketResourceInfo, type MarketService, type NFTCollateralConfig, type NFTCollateralInfo, type NFTCollateralPositionData, type NFTLiquidationValue, type NonFungibleResource, type OnLedgerCdpData, type OperatingStatusValue, PoolOperations, type PriceFeed, PROTOCOL_INTEREST_SHARE, type RegisteredNFTResourceType, type RegisteredResourceType, type ResourceConfig, type ResourcePoolConfig, type ResourcePoolState, resourceToDuMapping, type ReturnedResourcePoolState, type ServiceManager, servicePlugin, serviceStatusStrategyPlugin, STAKEHOLDER_REWARD_SHARE, WEFT_RESOURCE, WEFT_STAKING_COMPONENT, WeftLedgerSateFetcher, WeftLedgerStateClient, type WeftRadixApiServiceInterface, WeftStakingOperations, XUSDC_RESOURCE }
