...
const dec = input => new Decimal(input)
const ZERO = dec(0)
const ONE = dec(1)
const ONE_HUNDRED = dec(100)
const PRECISE_ZERO = dec(0)
const PRECISE_ONE = dec(1)
const PRECISE_ONE_HUNDRED = dec(100)
...
const FungibleResourceCollectionState = class {
  constructor(entity, stateFetcher) {
    this.values = {}
    this.initialized = false
    this.entity = entity
...
const NonFungibleResourceCollectionState = class {
  constructor(entity, stateFetcher) {
    this.values = {}
    this.initialized = false
    this.entity = entity
...
const EntityStateFetcher = class _EntityStateFetcher {
...
const serviceStatusStrategyPlugin = {
  tupleName: 'ServiceStatus',
  parser: (tupleObject, _fetcher) => {
    return tupleObject._unnamedField0
  },
}
const configAndServiceKeyPlugin = {
...
// src/api/base-client.ts
const WeftLedgerStateClient = class _WeftLedgerStateClient {
...
// src/lib/const.ts
const LENDING_POOL_COMPONENT = 'component_rdx1czmr02yl4da709ceftnm9dnmag7rthu0tu78wmtsn5us9j02d9d0xn'
const LENDING_MARKET_COMPONENT = 'component_rdx1cpy6putj5p7937clqgcgutza7k53zpha039n9u5hkk0ahh4stdmq4w'
const WEFT_STAKING_COMPONENT = 'component_rdx1cqzle2pft0y09kwzaxy07maczpwmka9xknl88glwc4ka6a7xavsltd'
...
const LENDING_POOL_RESOURCE_POOL_KVS = 'internal_keyvaluestore_rdx1kzjr763caq96j0kv883vy8gnf3jvrrp7dfm9zr5n0akryvzsxvyujc'
const LENDING_POOL_SERVICE_KVS = 'internal_keyvaluestore_rdx1krz350jhmvvuw2cctslmg3axnxagqas4muf5rxvfd8jcqru7s4v9a3'
const LENDING_MARKET_PRICE_CACHE_KVS = 'internal_keyvaluestore_rdx1krnvw2lrk6jdhemskgsjldjahq2aatvycpwuuccaap93880hr2s0dh'
const LENDING_MARKET_RES_CONFIG_KVS = 'internal_keyvaluestore_rdx1kr89xu06dc83cqvevjs22hg202pkm4xmh5qeka29rc94r2af7vc55n'
const LENDING_MARKET_COLLATERAL_CONFIG_KVS = 'internal_keyvaluestore_rdx1krp789s9vy4rny9c6wsm2hs3nxgxxnhafxs2t2lv9qpkdze6rna8qe'
const LENDING_MARKET_LOAN_CONFIG_KVS = 'internal_keyvaluestore_rdx1kqhrmxz9dltruje0z2flxy86v9gm58vs38y3kjqxcazhy63z94zmre'
const LENDING_MARKET_EFFICIENT_GROUP_KVS = 'internal_keyvaluestore_rdx1kpcw9se76zuryjp2ju7jl3xk9mea32fgj7w83mxq8tx0fgl8a4w7mc'
const LENDING_MARKET_LOAN_SERVICE_KVS = 'internal_keyvaluestore_rdx1krqp74wz473l3d7v08m3v66kv46fe03aq5retc7hhy7ha9vgedfha7'
const LENDING_MARKET_COLLATERAL_SERVICE_KVS = 'internal_keyvaluestore_rdx1kzsa48ew4vwj7l3y0wdxkkgz6lrrg50lyultllruqzaqawkesf2gre'
const CDP_RESOURCE = 'resource_rdx1nt22yfvhuuhxww7jnnml5ec3yt5pkxh0qlghm6f0hz46z2wfk80s9r'
const WEFT_RESOURCE = 'resource_rdx1tk3fxrz75ghllrqhyq8e574rkf4lsq2x5a0vegxwlh3defv225cth3'
const XUSDC_RESOURCE = 'resource_rdx1t4upr78guuapv5ept7d7ptekk9mqhy605zgms33mcszen8l9fac8vf'
const PROTOCOL_INTEREST_SHARE = 0.2
const STAKEHOLDER_REWARD_SHARE = 0.5
const resourceToDuMapping = /* @__PURE__ */ new Map([
...
const duToResourceMapping = new Map([...resourceToDuMapping].map(([k, v]) => [v.du, k]))
const defaultLendingPools = [...resourceToDuMapping.keys()]
    ...
    do {
      const res = await this.client.getGatewayApi().state.innerClient.nonFungibleIds({
        stateNonFungibleIdsRequest: {
          ...
          cursor: nextCursor,
          at_ledger_state: at_ledger_state === void 0
            ? null
            : {
...
const ComponentResourceOperations = class {
  constructor(client) {
    this.client = client
  }
...
const WeftStakingOperations = class {
...
// src/api/index.ts
const WeftLedgerSateFetcher = class _WeftLedgerSateFetcher {
  constructor(client) {
    this.client = client
