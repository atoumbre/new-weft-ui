...
import_decimal2.default.set({ precision: 50, rounding: import_decimal2.default.ROUND_DOWN, toExpNeg: -50, toExpPos: 50 });
...
// src/api.ts
import_decimal3.default.set({ precision: 50, rounding: import_decimal3.default.ROUND_DOWN, toExpNeg: -50, toExpPos: 50 });
var WeftLedgerSateFetcher = class _WeftLedgerSateFetcher {
  ...
  static setInstance(radixGatewayApi) {
    if (!this.instance) {
      const defaultApi = radixGatewayApi ?? import_babylon_gateway_api_sdk2.GatewayApiClient.initialize({
        basePath: "https://mainnet.radixdlt.com",
