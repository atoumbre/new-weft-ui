...
<div class="container mx-auto px-4 py-8 space-y-8">
  <div class="flex items-center justify-between">
    <div>
      <h1 class="text-3xl font-bold mb-2">CDP Management</h1>
                    ...
                    {#snippet right()}
                      <div class="flex items-center gap-6">
                        <div class="text-right">
                          <AmountDisplay amount={dec(parseUnitsStr(collateral.amount))}  usd={dec(parseUsdStr(collateral.value))} />
                        </div>
                        <div class="text-right">
              ...
              {#each currentCDP.loans as loan}
                <ListRow>
                  ...
                  {#snippet right()}
                    <div class="flex items-center gap-6">
                      <div class="text-right">
                        <AmountDisplay amount={dec(parseUnitsStr(loan.borrowed))}  usd={dec(parseUsdStr(loan.price)).mul(dec(parseUnitsStr(loan.borrowed)))} />
                      </div>
                      <div class="text-right">
